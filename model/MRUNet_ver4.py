...
class MRUNet_ver4():
    def __init__(self, input_shape, mr1_input_shape, mr2_input_shape):
        with tf.variable_scope("U-Net"):
            ...
            #mr1: t 512 to 256
            self.mr1_conv1 = Conv2D(8, self.kernel_size, self.t_mr1_stride, input_shape=mr1_input_shape, padding='same')
            ...
            # endcoder
            self.conv1  = Conv2D(8, self.kernel_size, self.f_mr1_stride, input_shape=input_shape, padding='same')

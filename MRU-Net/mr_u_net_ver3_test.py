...
class Test():
        ...
        def __call__(self):                                              
                ...
                saver = tf.train.import_meta_graph('./../results/model/MRUNet_ver3/mr_u_net_ver3_1998.ckpt.meta')
                with tf.Session(config = config) as sess:
                        saver.restore(sess, './../results/model/MRUNet_ver3/mr_u_net_ver3_1998.ckpt')
...
#    scipy.io.savemat("./../results/mat/u_net_2_sar.mat", {'u_net_2_sar_list':sar_list})
    file_path = './../results/audio/MRUNet_ver2/singing_voice_separation/'

...
class Test():
        ...
        def __call__(self):                                              
                ...
                saver = tf.train.import_meta_graph('./../results/model/MRUNet_ver2/mr_u_net_ver2_1998.ckpt.meta')
                with tf.Session(config = config) as sess:
                        saver.restore(sess, './../results/model/MRUNet_ver2/mr_u_net_ver2_1998.ckpt')

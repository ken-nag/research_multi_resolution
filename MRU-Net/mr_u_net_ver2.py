...
class Train():
        ...
        def __model(self, tf_mix, tf_target, tf_lr):
                ...
                tf_est_masks = mr_u_net_ver2(tf_f_512_mag_spec_mix, tf_mr_f_256_mag_spec_mix)
        ...
        def __call__(self):                                              
                ...
                with tf.Session(config = config) as sess:
                        ...
                        net_saver = NetSaver(saver_folder_name='MRUNet_ver2',  saver_file_name='mr_u_net_ver2')

...
#             tf_mag_spec_mix = stft_module.to_magnitude_spec(tf_spec_mix, normalize=False)
        ...
        def __call__(self):                                              
                ...
                with tf.Session(config = config) as sess:
                        ...
                        net_saver = NetSaver(saver_folder_name='UNet_other_sources_drum',  saver_file_name='u_net_drum')
                        ...
                        for epoch in range(self.epoch_num):
                                ...
                                train_target_array = train_arg_drums_array
                                ...
                                valid_target_array = valid_arg_drums_array
#                                
                                # training

...
from model.mini_UNet_ver2 import mini_UNet_ver2
...
class Train():
        ...
        def __model(self, tf_mix, tf_target, tf_lr):
                ...
                tf_est_masks, _, _, _, _, _ = mini_u_net_ver2(tf_f_512_mag_spec_mix,  tf_mr1_f_256_mag_spec_mix)
        ...
        def __call__(self):                                              
                ...
                with tf.Session(config = config) as sess:
                        ...
                        net_saver = NetSaver(saver_folder_name='mini-U-Net_ver2',  saver_file_name='mini-U-Net_ver2')
